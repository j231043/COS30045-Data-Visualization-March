...
const content_tv = `
    <h1>TV</h1>
    <p>Depending on level of usage, TV may be a take up a portion of energy bills. However, that does not mean that we should stop watching TVs, but rather we should purchase energy efficient TVs so that we are able to continue watching TVs without putting a dent on our budget. However, there are so many TV models in the market that consumers get confused on how to select the most energy efficient TV. For example, according to the energy rating data for household appliances provided by the Australian government for our research (the data for TV is available at: <a href="https://data.gov.au/data/dataset/energy-rating-for-household-appliances/resource/93a615e5-935e-4713-a4b0-379e3f6dedc9">https://data.gov.au/data/dataset/energy-rating-for-household-appliances/resource/93a615e5-935e-4713-a4b0-379e3f6dedc9</a>), there are 4573 TV models in Australia currently available in the market. With so many models to choose from, how do consumers ensure that they are selecting the most energy efficient model to minimize their energy bills?
    <br><br>
    There are several factors that influences the energy consumption of TVs, including screen technology and screen size.</p>
